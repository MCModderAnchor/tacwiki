...
| 字段                         | 类型   | 必填   | 说明                          | 详情              |
|----------------------------|------|------|-----------------------------|-----------------|
| ammo.tracer_color          | 字符串  | 否    | 曳光弹颜色（RGB 十六进制），如 `#FF8888` | [子弹特效](07_ammo) |
| ammo.enable_bullet_hole    | 布尔值  | 否    | 是否保留弹孔贴花                    | [子弹特效](07_ammo) |
| ammo.hit_surface_particles | 数组   | 否    | 命中方块表面时播放的粒子效果              | [子弹特效](07_ammo) |
| ammo.particle              | 对象   | 否    | 子弹飞行时拖尾粒子                   | [子弹特效](07_ammo) |
### 音效
| 字段     | 类型   | 必填   | 说明       | 详情              |
|--------|------|------|----------|-----------------|
